...
const prompt = ChatPromptTemplate.fromMessages([
    ...
    [
            "issue": "issue1, Max length is 25 Words, Use latitude and longitude to determine the location, display the place name to the user without showing the actual coordinates but sometimes you could display it. and other data to provide a more specific issue",
